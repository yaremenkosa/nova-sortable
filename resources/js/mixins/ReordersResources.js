    ...
    methods: {
        async updateOrder(event) {
            ...
            try {
                ...
                if (e?.response?.data?.canNotReorder) {
        ...
        async moveToStart(resource) {
            ...
            try {
                await Nova.request().post(
                    `/nova-vendor/nova-sortable/sort/${this.resourceName}/move-to-start`,
                    {
        ...
        async moveToEnd(resource) {
            ...
            try {
                await Nova.request().post(
                    `/nova-vendor/nova-sortable/sort/${this.resourceName}/move-to-end`,
                    {
                        resourceId: resource.id.value,
                        viaResource: this.viaResource,
                        viaResourceId: this.viaResourceId,
